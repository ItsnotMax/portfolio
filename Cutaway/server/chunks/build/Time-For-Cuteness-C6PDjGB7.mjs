import { withAsyncContext, mergeProps, unref, useSSRContext, ref, withCtx, createTextVNode } from 'vue';
import { u as useHead } from './index-CCqbQxu4.mjs';
import { u as useFetch } from './fetch-CGGzF4w1.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="wrapper mx-auto" data-v-093bb225><ul class="container mx-auto border-[1rem]" data-v-093bb225><!--[-->`);
      ssrRenderList(props.imagesList, (link, index) => {
        _push(`<li class="wrapper__item" data-v-093bb225><img${ssrRenderAttr("src", link)} alt="there is cute" data-v-093bb225></li>`);
      });
      _push(`<!--]--></ul></div>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        class: "absolute top-0 left-0 text-[2rem]",
        to: "/"
      }, {
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Cuteness.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const Cuteness = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-093bb225"]]);
const _sfc_main = {
  __name: "Time-For-Cuteness",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    const { data: imagesList } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/cuteness", "$PuisLIs0GO")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(Cuteness, mergeProps({ imagesList: unref(imagesList) }, _attrs), null, _parent));
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Time-For-Cuteness.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Time-For-Cuteness-C6PDjGB7.mjs.map
