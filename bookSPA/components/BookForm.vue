		...
		<form @submit.prevent="sendForm" class="flex flex-col gap-4">
			...
			>
				...
				<svg
					width="18"
					height="18"
					class="absolute left-[7px]  opacity-0 transition-all duration-[300ms] peer-checked:opacity-100 top-[14px] sm:top-[3px]"
				>
			...
			<div class="flex justify-end items-center gap-2">
				<button
					...
					:class="{
						...
						'bg-[#1C7D41] hover:bg-[#19713B]': isFormValid,
				...
				>
					...
					<span
						class="text-white text-[14px] transition-all duration-300"
