...
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, f as createError$1, o as defu, p as sanitizeStatusCode, q as getContext, r as createHooks, v as toRouteMatcher, x as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-6npNRdA6.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BoReGL5Z.mjs'))
};
